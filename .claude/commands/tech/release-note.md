...
| "Migration webpack -> Turbopack"        | _Internal only - don't communicate_       |
| "Refactor React hooks architecture"     | _Internal only - don't communicate_       |
...
2. Run: /release-note (or specify version/range)
...
# Specify range
/release-note from v1.4.0 to HEAD

# Preview without creating files
/release-note --preview

# Include pre-release commits
/release-note --include-pre-release
```
